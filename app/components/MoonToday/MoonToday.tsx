  ...
  if (!moonToday)
    return (
      <div className={css.wellcomeLoading}>
        ...
        <p className={css.textWellcomeLoading}>
          Місяць рухається за певним циклом, і разом із ним змінюються наші
          стани, рішення, енергія та внутрішня рівновага. Цей календар
          створений, щоб допомогти тобі відчувати ці зміни, розуміти їх і
          використовувати на свою користь.
        </p>
