...
export const aspectLabels: Record<LuckyKeys, string> = {
  ...
  bossCommunication: "Спілкування з керівництвом",
...
// --------------------------------------------------
// 3. Ключ-назва для фільтрації об'єктів Календар
// --------------------------------------------------

export const aspectTitles: Record<string, string> = {
  newActivities: "Нові справи",
  decisionMaking: "Приняття рішень",
  business: "Бізнес",
  money: "Гроші",
...
// --------------------------------------------------
// 4. aspectGroups — ділення значень на групи Календаря
// --------------------------------------------------

export const aspectGroups: Record<string, string> = {
  business: "Важливе",
  jobChange: "Важливе",
...
// --------------------------------------------------
// 5. aspectMap — універсальний доступ до значень
// --------------------------------------------------
